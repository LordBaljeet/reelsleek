...
class VideoControl {
  ...
  <button class="reelsleek-fullscreen-button" aria-label="Toggle fullscreen" title="Toggle fullscreen">
...
`;
  ...
  static attach(video) {
    ...
    const updateSeekFill = () => seekbar.style.setProperty("--seekbar-fill", seekbar.value + "%");
